...
public class DocumentMetadata implements Serializable {
    ...
    private static final Logger LOG = Logger.getLogger(DocumentMetadata.class.getName());
    ...
    public DocumentMetadata(Properties properties) {
        ...
        if(dateString!=null) {
            try {
                ...
                LOG.log(Level.SEVERE,"Error while parsing date string: " + dateString + ", format is: yyyy-MM-dd" , e);
            }
        }    
    }
