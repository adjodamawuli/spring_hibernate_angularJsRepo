 ...
 */
@Service("documentRepo")
public class FileSystemDocumentDao implements IDocumentRepo {

    private static final Logger LOG = Logger.getLogger(FileSystemDocumentDao.class.getName());
